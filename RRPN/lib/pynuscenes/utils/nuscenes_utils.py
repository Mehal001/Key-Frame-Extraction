...
def nuscene_cat_to_new_coco(nusc_ann_name):

    ## Convert nuscene categories to COCO cat, cat_ids and supercats
    try:
        coco_equivalent = NS_C.COCO_NEW_SUB_CLASSES[nusc_ann_name]
    except KeyError:
        return None, None, None, None

    coco_class = coco_equivalent['class']
    coco_cat = nusc_ann_name
    coco_id = coco_equivalent['id']
    coco_supercat = coco_equivalent['supercategory']

    return coco_cat, coco_id, coco_supercat, coco_class 
